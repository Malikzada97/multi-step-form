...
export function nextStep(formState, formSteps, ...args) {
    if (formState.currentStep < formSteps.length) {
        formState.currentStep++;
        showStep(formState.currentStep, ...args);
    }
}

export function prevStep(formState, formSteps, ...args) {
...
export function goToStep(step, formState, formSteps, ...args) {
